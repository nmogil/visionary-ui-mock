  ...
  return (
    ...
    >
      <Input
        ...
        className="h-12 text-center tracking-[0.1em] uppercase md:h-12 [&::placeholder]:tracking-normal [&::placeholder]:normal-case [&::placeholder]:text-xs md:[&::placeholder]:text-sm"
      />
